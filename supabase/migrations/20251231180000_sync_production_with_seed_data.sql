...
-- 1. INSERT new rescues not in production
-- 2. UPDATE existing rescues with changed data
-- 3. DELETE rescues no longer in the authoritative seed data
-- 4. Only updates records when there are actual differences to minimize audit log noise
